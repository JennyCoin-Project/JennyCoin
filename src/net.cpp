...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "JennyCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cryptopirates.net", "64.39.227.156"},
    {"JennyCoinpool.org", "54.72.84.73"},
    {"xurious.com", "54.193.78.208"},
...
static const char *strTestNetDNSSeed[][2] = {
    //{"JennyCointools.com", "testnet-seed.JennyCointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. JennyCoin is probably already running."), addrBind.ToString().c_str());
        else
